      ...
      <div className="cla-width-container">
        <div className="d--flex m--t-xlarge">
          <div className="ls-grid-column-one-half">
            <div>
              <h1 className="m--b-xlarge">Sorry, we can't seem to find your details.</h1>
                
              <div className="m--b-xlarge">
                <p>
          
                  Contact us at Livestock Information, we're here to help register you account. 
                  Email us, <LsLink>devsupport@livestockinformation.org.uk</LsLink> Our
                  support team will get back to you within 2 working days.
                </p>
                <p>Alternatively, you can contact us via telephone line: </p>
                <p className="p--large">
