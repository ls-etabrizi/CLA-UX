      ...
      <div className="cla-width-container">
        <div className="d--flex m--t-xlarge">
          <div className="ls-grid-column-two-thirds">
            <div>
              <h1 className="m--b-xlarge">Please create your user name</h1>
              <p className="m--b-large">
               Now that you've completed verification via your mobile number, we need you to create a user name. 
              </p>
